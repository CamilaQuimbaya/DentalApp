<template>
    <div class="contentt">
      ...
      <div class="container-fluid">
        <img src="../assets/logosi.svg" class="logoicon" @click="reload" />
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="d-flex">
            <button class="afi"><span>Afiliate ya</span></button>
          </div>
        </div>
      </div>
    </nav>
...
<style>
.contentt {
  background-image: url("../assets/otherBackground.png");
...
.logoicon {
  ...
  .afi {
    ...
    border-radius: 10px;
    box-shadow: 0px 0px 5px 7px #339fe731;
    background-color: #3387e7;
    color: white;
    font-size: 1rem;
    border: none;
    display: flex;
  ...
  .afi:hover {
    ...
    transition: all 0.5s ease-in-out;
    box-shadow: 0px 0px 5px 3px #3363e773;
  }
